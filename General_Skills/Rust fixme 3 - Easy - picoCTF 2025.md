# Rust fixme 3 - Easy - picoCTF 2025
...
```rust
┌──(kali㉿kali)-[/tmp/rust_proj/fixme3/src]
└─$ cargo build 
...
└─$ cargo run  
    Finished `dev` profile [unoptimized + debuginfo] target(s) in 0.00s
     Running `/tmp/rust_proj/fixme3/target/debug/rust_proj`
Using memory unsafe languages is a: PARTY FOUL! Here is your flag:
```

---

`picoCTF{n0w_y0uv3_f1x3d_1h3m_[REDACTED]}`