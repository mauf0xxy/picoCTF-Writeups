# fixme1.py - Easy - Beginner picoMini 2022
...
flag = str_xor(flag_enc, 'enkidu')
	print('That is correct! Here\'s your flag: ' + flag) ### Remove this space
```

```python
mauf0xxy-academy@webshell:~$ python
...
>>> 
>>> flag = str_xor(flag_enc, 'enkidu')
>>> print('That is correct! Here\'s your flag: ' + flag) ### Remove the space before the print() function
That is correct! Here's your flag:
```

---

`picoCTF{1nd3nt1ty_cr1515_[REDACTED]}`