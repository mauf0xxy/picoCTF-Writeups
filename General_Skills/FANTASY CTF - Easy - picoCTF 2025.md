# FANTASY CTF - Easy - picoCTF 2025

> Hint: When a choice is presented like [a/b/c], choose one, for example: **`c`** and then press Enter.
> 

---

```
mauf0xxy-academy@webshell:~$ nc verbal-sleep.picoctf.net 55560
...
winners.
4. picoCTF{m1113n1um_3d1710n_[REDACTED]} is a real flag! Submit it for some
points in picoCTF 2025!
```

---

`picoCTF{m1113n1um_3d1710n_[REDACTED]}`